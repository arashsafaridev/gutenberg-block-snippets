...
const { Button, SVG, Path, PanelBody, PanelRow, ToggleControl, TextControl } = wp.components;
...
const withInspectorControls = createHigherOrderComponent( ( BlockEdit ) => {
    return ( props ) => {
        ...
        return (
            <>
                <BlockEdit { ...props } />
                <BlockControls key="meetingControls">
                    <div className="components-toolbar">
                        <Button className="components-toolbar__control has-icon"
